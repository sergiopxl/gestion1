...
$idProveedor = $_PUT["input-contacto-idProveedor"];
...
$sqlContactosInsert = "INSERT INTO proveedores_contactos_tb
                         (name, apell1, apell2, phone1, mail1, id_proveedor)
                       VALUES
                         ('$nombre', '$apellido1', '$apellido2', '$telefono', '$email', $idProveedor)";
